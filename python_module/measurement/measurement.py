...
def main():
	print "--- main starts ---"
	startUTCtime = time.time()
	startTime = get_time()
	myFile_power = "log_"+time.strftime("%Y_%m_%d_%H_%M_%S", time.localtime(startUTCtime))+"_power.log"
	myFile_socket = "log_"+time.strftime("%Y_%m_%d_%H_%M_%S", time.localtime(startUTCtime))+"_socket.log"
